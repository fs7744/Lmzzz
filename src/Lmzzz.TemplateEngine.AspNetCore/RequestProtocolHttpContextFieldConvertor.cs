...
public class RequestProtocolHttpContextFieldConvertor : HttpContextFieldConvertor
{
    private readonly IHttpConditionStatement isnull;

    public RequestProtocolHttpContextFieldConvertor()
    {
        isnull = CreateAction(c => c.Request.Protocol is null);
    }
